          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                id="name"
                name="name"
                className={`shadow-sm h-10 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-500 ring-2 rounded-md ${
          ...
          <div>
            ...
            <div className="mt-1">
              <textarea
                ...
                name="description"
                rows={4}
                className={`shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full h-32 sm:text-sm ring-2 border-gray-500 rounded-md ${
